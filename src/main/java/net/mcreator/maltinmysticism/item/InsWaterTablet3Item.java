...
public class InsWaterTablet3Item extends MaltinmysticismModElements.ModElement {
			...
			if (this.inGround) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					InsWaterTablet3ExplosionProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("maltinmysticism:watersplash3")),
