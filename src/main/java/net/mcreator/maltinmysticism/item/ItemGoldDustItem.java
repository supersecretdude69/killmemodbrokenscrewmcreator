...
public class ItemGoldDustItem extends MaltinmysticismModElements.ModElement {
	@ObjectHolder("maltinmysticism:item_gold_dust")
	public static final Item block = null;
	public ItemGoldDustItem(MaltinmysticismModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("item_gold_dust");
		}
