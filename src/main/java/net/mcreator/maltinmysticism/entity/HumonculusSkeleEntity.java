...
public class HumonculusSkeleEntity extends MaltinmysticismModElements.ModElement {
	public static EntityType entity = null;
	public HumonculusSkeleEntity(MaltinmysticismModElements instance) {
		super(instance, 107);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("humonculus_skele")
						.setRegistryName("humonculus_skele");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -3355444, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("humonculus_skele_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelcustom_model(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("maltinmysticism:textures/humunculustextureskeleton.png");
				}
			};
		});
	}
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Skeleton Homunculus");
					}
